...
def getClassName(fullName: str) -> str:
    """
    Args:
        fullName (str): The full name of the method (e.g. TestClass.testMethod)

    Returns:
        str: The name of the class (e.g. TestClass)
    """
    return fullName.split('.')[0]

def getMethodName(fullName: str) -> str:
    """
    Args:
        fullName (str): The full name of the method (e.g. TestClass.testMethod)

    Returns:
        str: The name of the method (e.g. testMethod)
    """
